...
namespace API_Solution.Extensions
{
    public static class ServiceExtensions
    {
        ...
        public static void ConfigureSqlContext(this IServiceCollection services, IConfiguration configuration) =>
             ...
             b.MigrationsAssembly("API_Solution")));
        ...
        public static void ConfigureVersioning(this IServiceCollection services)
        {
            services.AddApiVersioning(opt =>
            {
                ...
                opt.Conventions.Controller<PilorsController>().HasDeprecatedApiVersion(new ApiVersion(1,0));
                opt.Conventions.Controller<PilorsV2Controller>().HasDeprecatedApiVersion(new ApiVersion(2,0));
            });
        }
    }    
}
